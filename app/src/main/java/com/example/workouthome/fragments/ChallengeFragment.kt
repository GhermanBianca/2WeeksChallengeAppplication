...
class ChallengeFragment : Fragment(R.layout.fragment_challenge) {
    ...
    private fun setChallengeList() : ArrayList<ChallengeItem> {
        ...
        challengeArrayList.add(ChallengeItem("Antrenament complet", R.drawable.full_body))
        challengeArrayList.add(ChallengeItem("Fesieri & Abdomen", R.drawable.buttock))
        challengeArrayList.add(ChallengeItem("Cardio", R.drawable.cardio_fight))
        challengeArrayList.add(ChallengeItem( "Antrenament complet", R.drawable.full_body))
        challengeArrayList.add(ChallengeItem( "Fese & Coapse", R.drawable.buttock_twigh))
        challengeArrayList.add(ChallengeItem ("Yoga", R.drawable.yoga))
        challengeArrayList.add(ChallengeItem( "Relaxare", R.drawable.relax))
        challengeArrayList.add(ChallengeItem( "Antrenament complet", R.drawable.full_body))
        challengeArrayList.add(ChallengeItem( "Fese & Coapse & Abdomene", R.drawable.buttock_twigh))
        challengeArrayList.add(ChallengeItem( "Cardio", R.drawable.cardio_fight))
        challengeArrayList.add(ChallengeItem( "Antrenament complet", R.drawable.full_body))
        challengeArrayList.add(ChallengeItem( "Fese & Coapse", R.drawable.buttock_twigh))
        challengeArrayList.add(ChallengeItem( "Yoga", R.drawable.yoga))
