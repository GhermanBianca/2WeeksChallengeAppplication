...
class ChallengeFragment : Fragment(R.layout.fragment_challenge) {
    ...
    private fun setChallengeList(): ArrayList<DayChallengeItem> {
        ...
        dayChallengeArrayList.add(
            DayChallengeItem(
                resources.getString(R.string.fullbody),
                R.drawable.full_body
            )
        )
        dayChallengeArrayList.add(
            DayChallengeItem(
                resources.getString(R.string.buttocks_abs),
                R.drawable.buttock
            )
        )
        dayChallengeArrayList.add(
            DayChallengeItem(
                resources.getString(R.string.cardio),
                R.drawable.cardio_fight
            )
        )
        dayChallengeArrayList.add(
            DayChallengeItem(
        ...
        dayChallengeArrayList.add(
            DayChallengeItem(
                resources.getString(R.string.buttock_thigs),
                R.drawable.buttock_twigh
            )
        )
        dayChallengeArrayList.add(
            DayChallengeItem(
        ...
        dayChallengeArrayList.add(
            DayChallengeItem(
                resources.getString(R.string.relax),
                R.drawable.relax
            )
        )
        dayChallengeArrayList.add(
